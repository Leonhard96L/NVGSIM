...
dest_dir = r'D:\entity\rotorsky\as532\resources\MQTG_Comparison_with_MQTG_FTD3\Reference_data_Init_flyout_V3'
...
def get_init_cond_from_xml(path):
    ...
    init_cond_dict = {
        ...
        root[4][2][24].attrib.get('name') : root[4][2][24].attrib.get('valueSIM')                   #TM Mode
...
def find_results_xml(root_dir):
    ...
    for subdir, _, files in os.walk(root_dir):
        if 'Results.xml' in files:
            ...
            json_file_path = os.path.join(subdir, 'init_conditions.json')
