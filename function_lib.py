...
#                             'condition': '0 KIAS, -1000 fpm, up input',
...
#                             'automatic_testing': [],
#                             'manual_testing': [
#                                 'Write the name of the test into the brackets of the function(1.a.3_A1, ‘manu’).Click RUN or press F5.',
...
#             'test_parts': [
#                 {
#                     # Placeholder for additional test parts
#                 }
#             ]
#         }
#     ]
